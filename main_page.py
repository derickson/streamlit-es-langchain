...
st.markdown('<a href="/🦙_llama2" target="_self">Llama2</a>', unsafe_allow_html=True)
st.markdown('<a href="/ELSER_NSF_search" target="_self">ELSER NSF Search</a>', unsafe_allow_html=True)
